 ...
 * <br><br>
 * La méthode {@link #transform(Object)} doit être définie de telle sorte qu'elle renvoie la variante de l'objet source selon la variation donnée en paramètre.
 * <br><br>
 * Voici un exemple de son utilisation :
 * <br><pre><code>
 * BufferedTransformation<String,Integer> substring = new BufferedTransformation<String,Integer>(someString) {
...
public abstract class BufferedTransformation<Src,Trans> extends BufferedProcessor<Trans,Src> {
	 ...
	 * @param transformation  l'objet correspondant à la transformation
	 * @return  la version transformée de l'objet source
	 */
	protected abstract Src transform(Trans transformation);
	
	/** Implémentation interne de la méthode {@link BufferedProcessor#process(Object)}.
	 * Cette implémentation appelle directement {@link #transform(Object)}.
	 * @param transformation  l'objet correspondant à la transformation
	 * @return  la version transformée de l'objet source
	 ...
	 * @param transformation  l'objet fourni en entrée
	 ...
	 * @param transformations  la collection des transformations à traiter
